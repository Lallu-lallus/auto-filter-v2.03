...
async def cb_navg(bot, update: CallbackQuery):
    ...
    text=f"<i>Found</i> <code>{leng}</code> <i>thaankal chodicha file enta data base il ndu thazhe kaanunna button click cheythu download cheytholu👇👇👇:</i> <code>{query}</code>"
